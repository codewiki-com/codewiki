...
| `import.json`               | `pnpm content:import`    | Result of the staging import: how many files were written, the pairs the mapping dropped with their reasons, the imported pair count per track and section, and a histogram of the issues the staged files carry.     |
