...
> [!PITFALL]
> `typeof`, statement expressions, `, ##__VA_ARGS__`, and vendor-specific pragmas may work in the current compiler without belonging to the target C23 interface. Copying these forms from older projects without naming the dialect hides the portability constraint.
