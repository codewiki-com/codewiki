...
> [!PITFALL]
> `profiles[id].Name = "Lin"` does not compile because a map index expression is not an addressable struct variable. Slice index expressions have different addressability rules.
