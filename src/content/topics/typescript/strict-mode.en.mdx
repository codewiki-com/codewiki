...
`alwaysStrict` concerns ECMAScript runtime strict semantics, such as rejecting certain silent failures and legacy syntax. TypeScript's `strict` umbrella includes it, but the other options in this article mostly change static type checking.
