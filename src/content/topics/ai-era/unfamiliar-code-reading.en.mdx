...
> [!PITFALL]
> One successful run proves little about missing fields, empty collections, boundary values, exceptions, retries, or repeated calls. Collapsing several branches into a single clean narrative hides those differences.
