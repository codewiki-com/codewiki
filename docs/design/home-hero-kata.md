...
- Then, in this order: personal strip (returning visitors), **flagship tracks** (see `flagship-tracks.md`), feature grid (01–06), modes, ask-AI. The old "daily kata" section between personal strip and features is gone (it is the hero now).
