...
- **P2b status (2026-09-04 16:20 local):** Tasks 12, 13, 14, 15, 17 done and merged into `p2-learning-layer` (339 unit, 1,940 links); Task 16 (gates + docs) running on Codex; then whole-branch review (`review-p2b-codex.md`), fix round if needed, merge to `main`.
