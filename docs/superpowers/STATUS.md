...
| P0 content pipeline | Tasks 1–13 complete on `p0-content-pipeline`; Task 14 wave 1 in progress (tier 1: 64/257 polished after batches 1–3, batch 4 running; the one dead-link failure passed on retry). P0 branch still needs `main` merged in after the current batch (it carries the P1 code from before Task 19) |
| P2 learning layer | plan `docs/superpowers/plans/2026-09-04-p2-learning-layer.md`; worktree `.worktrees/p2-learning-layer` (branch from main 3644c06); ledger `.worktrees/p2-learning-layer/.superpowers/sdd/2026-09-04-p2-learning-layer/progress.md`; Tasks 1–6 complete, Task 7 running on Codex |
