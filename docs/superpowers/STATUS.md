...
- **P2b status (2026-09-04 16:20 local):** Tasks 12, 13, 14, 15, 17 done and merged into `p2-learning-layer` (339 unit, 1,940 links); Task 16 done (18ee117; 10 Lighthouse URLs pass); whole-branch review running on Codex (`review-p2b-codex.md`), then fix round if needed and merge to `main`.
