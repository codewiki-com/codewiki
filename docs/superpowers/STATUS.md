...
| P0 content pipeline | Tasks 1–13 complete on `p0-content-pipeline`; Task 14 wave 1 in progress (tier 1: 128/257 polished after batches 1–7; batch 8 running with --n 10 --max 50). P0 branch still needs `main` merged in after the current batch (it carries the P1 code from before Task 19) |
