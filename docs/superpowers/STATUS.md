...
- **Routing (user, 2026-09-04 late):** Claude quota is plentiful — Opus takes insight-heavy content, reviews, complex merges/debugging; Codex keeps bulk mechanical work. Running jobs are never re-routed.
